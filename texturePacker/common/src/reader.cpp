...
{
    orderData(m_pData+m_offset, sizeof(unsigned int));
...
int Reader::readInt()
{
    orderData(m_pData+m_offset, sizeof(int));
    int result = 0;
...
{
    orderData(m_pData+m_offset, sizeof(float));
    float result = 0;
...
{
    orderData(m_pData+m_offset, sizeof(short));
    short result = 0;
